...
import { c as Ue, b as Qe, Y as Ye } from '../nitro/nitro.mjs';
import { Suspense, Show } from 'solid-js';
import { y as y$1 } from './createAsync-CBz8AaaQ2.mjs';
import { A } from './components-O97wFynQ.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const w = (_a = h.VITE_API_URL) != null ? _a : "http://localhost:3000", $ = Ye(async (o) => {
  try {
...
}, "src_routes_products_id_tsx--getProduct_cache", "/Users/tobiasbelch/workspaces/fea/education/web-framework-benchmark-2026/packages/solidstart/src/routes/products/[id].tsx?pick=default&pick=%24css&tsr-directive-use-server="), P = Qe($, "product");
function C() {
