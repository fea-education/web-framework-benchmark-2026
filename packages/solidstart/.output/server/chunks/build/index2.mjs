...
import { b as Qe, Y as Ye } from '../nitro/nitro.mjs';
...
const b = (_a = p.VITE_API_URL) != null ? _a : "http://localhost:3000", v = Ye(async () => {
  try {
...
}, "src_routes_index_tsx--getProducts_cache", "/Users/tobiasbelch/workspaces/fea/education/web-framework-benchmark-2026/packages/solidstart/src/routes/index.tsx?pick=default&pick=%24css&tsr-directive-use-server="), _ = Qe(v, "products");
function R() {
  const s = y(() => _());
