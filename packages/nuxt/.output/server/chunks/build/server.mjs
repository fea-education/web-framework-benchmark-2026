import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, toRaw, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { c as createError$1, p as parseURL$1, i as encodePath$1, k as decodePath, l as hasProtocol, m as isScriptProtocol, f as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch, o as defu, q as createHooks, r as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_v7roEm3z1NbDOHzM0UUD1J8O_Z_3gGGuEBlArMwunDs = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./cart-B_RdDUsH.mjs')
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-0rsxafJW.mjs')
  },
  {
    name: "filter",
    path: "/filter",
    meta: __nuxt_page_meta || {},
    component: () => import('./filter-swcP-neh.mjs')
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import('./_id_-DNCenly9.mjs')
  }
];
...
const revive_payload_server_kl4T_JfHKTLjUmbqdtPE0aX5pcZtBIKIYKY54hQLUGs = /* @__PURE__ */ defineNuxtPlugin({
...
const prerender_server_Ex9ZgNjSXqlRjTqoMzuCHUsyrrdA1DdeJDAnp6FLzYA = /* @__PURE__ */ defineNuxtPlugin(async () => {
  {
    return;
  }
});
const plugins = [
  payloadPlugin,
  unhead_v7roEm3z1NbDOHzM0UUD1J8O_Z_3gGGuEBlArMwunDs,
  plugin$1,
  revive_payload_server_kl4T_JfHKTLjUmbqdtPE0aX5pcZtBIKIYKY54hQLUGs,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4,
  prerender_server_Ex9ZgNjSXqlRjTqoMzuCHUsyrrdA1DdeJDAnp6FLzYA
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-y3TEQmxo.mjs').then((m) => m.default || m))
};
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.1_@emnapi+runtime@1.9.1_@parcel+watcher@2.5.6_@types+node@_03be835a7f483d3f7430b67dd31d3283/node_modules/nuxt/dist/pages/runtime/app.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D4grdzTS.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CQ5U5EIT.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.1_@emnapi+runtime@1.9.1_@parcel+watcher@2.5.6_@types+node@_03be835a7f483d3f7430b67dd31d3283/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.2_@emnapi+core@1.9.1_@emnapi+runtime@1.9.1_@parcel+watcher@2.5.6_@types+node@_03be835a7f483d3f7430b67dd31d3283/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRoute$1 as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, useRequestFetch as e, fetchDefaults as f, useRequestEvent as g, useRouter as h, encodeRoutePath as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
